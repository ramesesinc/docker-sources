...
function Controller( code, pages ) {
	...
	this.startProcessing = function() {
		var div = $('#overlay');
      	if(div.length == 0){
      		div = $('<div id="overlay"><center><img src="/js/lib/load.gif" align="middle" width="52" height="52" style="margin-top:25%"/></center></div>');
        	div.css({'position':'fixed', 'height':'100%','width':'100%','top':'0','right':'0','bottom':'0','left':'0','background':'rgba(0,0,0,0.35)','z-index':'999'});
        	div.appendTo($('body'));
        };					
	}
